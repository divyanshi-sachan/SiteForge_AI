> This app (SiteForge AI) is built on top of the **Bolt** open-source codebase. This repo contains a simple example app using the core components from bolt.new to help you get started building **AI-powered software development tools** powered by StackBlitz’s **WebContainer API**.
