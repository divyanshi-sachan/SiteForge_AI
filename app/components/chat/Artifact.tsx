      ...
      <div className="flex">
        ...
        >
          <div className="px-5 p-3.5 w-full text-left flex items-center gap-3">
            <div className="i-ph:magic-wand text-xl text-bolt-elements-item-contentAccent shrink-0" />
            <div>
              <div className="w-full text-bolt-elements-textPrimary font-medium leading-5 text-sm">
                {artifact?.title}
              </div>
              <div className="w-full text-bolt-elements-textSecondary text-xs mt-0.5">
                {artifact?.closed ? 'Website updated — click to view' : 'Building your website...'}
              </div>
            </div>
          </div>
        </button>
        ...
        <AnimatePresence>
          {actions.length && (
            <motion.button
              ...
              title={showActions ? 'Hide build details' : 'Show build details'}
            >
              <div className="p-4">
